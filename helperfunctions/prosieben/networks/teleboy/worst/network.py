...
if __name__ == "__main__":
    ...
    net.add(ConvolutionLayer(n_filter=16, width_filter=8, height_filter=8, stride=4,))
    net.add(BatchNorm())
    net.add(ReLU())
    net.add(ConvolutionLayer(n_filter=64, width_filter=4, height_filter=5, stride=1))
    net.add(BatchNorm())
    net.add(ReLU())
