...
Dieses ganze Kapitel bezieht sich auf das Buch von Michael A. Nielsen\cite{neuralbook}, ausser es wird anders deklariert.
...
wobei $a_{x, y}$ der Neuron an der Position $x, y$ ist.

Dadurch das immer die gleichen Gewichte und der gleiche Bias für jeden Filter benutzt werden,
wird überall das gleiche Merkmal erkannt selbst wenn es sich an verschiedenen Orten befinde,
...
\end{tikzpicture}
    \label{fig:conv4}
    \caption{Convolution Netzwerk mit 3 Feature Maps}%
\end{figure}
