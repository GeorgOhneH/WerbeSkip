...
In dem Beispiel auf Abbildung~\ref{fig:conv2} wird ein 3x3 Filter benutzt.
\begin{figure}[!h]
    \centering
\begin{tikzpicture}[
plain/.style={
...
\end{tikzpicture}
    ...
    \label{fig:conv2}
\end{figure}
Der Filter wird dann auf den Eingabeneuronen um ein Neuron verschoben, um den nächsten Neuron zu verbinden.
...
Falls nach einer Convolution-Schicht eine weitere Convolution-Schicht folgt, muss der Bereich des Filters zu allen feature maps erweitert werden\cite{conv} (siehe Abbildung~\ref{fig:conv5}).
\begin{figure}[!h]%
    \centering
...
Die Eingabeschicht würde aus drei feature maps bestehen, eine feature map für jeden Farbkanal des Bildes.
