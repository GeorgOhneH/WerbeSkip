...
Dafür wrd ein Neuronales Netzwerk benutzt, dass sich immer nur auf ein Bild benutzt und nicht eine Video sequenz.
\section{Logo}
...
Das grösste Problem um das Logo zu erkennen ist, dass das Logo nicht einfach über das normale Bild gelegt wird,
sondern es wird negativ multipliziert mit dem Bild, d.h die beiden Bilder werden invertiert, multipliziert und dann wieder invertiert.\cite{wiki:blend}
