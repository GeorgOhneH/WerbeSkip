...
Ein Problem des Logo's ist, dass es nicht komplett auf das normale Bild eingespielt wird, sondern man kann leicht hindurch sehen (siehe Abbildung~\ref{fig:logo2}a),
...
\begin{figure}[h]%
    ...
    \caption{8-malige Anwendung des gradient descent}%
    \label{fig:grad2}%
\end{figure}

Der Algorithmus funktioniert auch bei mehr als nur einer abhängigen Variable und lässt sich für die Gewichte und Biases des Netzwerkes genau gleich berechnen.
\begin{gather*}
...
Es wird immer noch stochastic gradient descent und backpropagation benutzt,
