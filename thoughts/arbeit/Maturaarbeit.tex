...
\draw[decorate,decoration={brace,mirror}] (x1.north west) -- node[left=10pt] {\parbox{2cm}{\center Eingabe\newline $n=3$}} (x3.south west);
\end{tikzpicture}
...
\draw[->] (h1) -- ($(center144) + (1, 0)$);

\node (h2) at (3, 1.5) {$w^3_{3,1}$};

\draw[->] (h2) -- ($(center28) + (0, 0)$);
...
In diesem Abschnitt wird nun untersucht, wie ein neuronales Netzwerk anhand von Daten lernen kann.
...
Im Beispiel in Abbildung~\ref{fig:conv2} wird ein 3x3 Filter benutzt.
\begin{figure}[!h]
    \centering
\begin{tikzpicture}[
plain/.style={
...
\foreach \ai in {7,...,9}
{\foreach \aii in {7,...,9}
  \node[circle, line width=1.5pt, draw, inner sep=5pt, scale=0.7] at (mat-\ai-\aii) {};
}
\foreach \ai in {7,...,9}
{\foreach \aii in {7,...,9}
...
\end{tikzpicture}
    \caption{Verbindung eines versteckten Neurons in einer Convolution-Schicht}
    \label{fig:conv2}
\end{figure}
Der Filter wird dann auf den Eingabeneuronen um ein Neuron verschoben, um die nächsten Neuronen zu verbinden.
Und so geht das weiter, auch nach unten, bis die neue versteckte Schicht vollständig erstellt worden ist.
...
Der Filter kann auch um mehr als nur ein Neuron verschoben werden.
Man kann in beide Richtungen verschiedene Schrittweiten nehmen.
Zum Beispiel bewegt sich der Filter um zwei Neuronen nach links und um drei nach unten.
\begin{figure}[!h]
    \centering
    \begin{tikzpicture}[
plain/.style={
...
Falls nach einer Convolution-Schicht eine weitere Convolution-Schicht folgt,
muss der Bereich des Filters zu allen Feature-Maps erweitert werden\cite{conv} (siehe Abbildung~\ref{fig:conv5}).
\begin{figure}[!h]%
    \centering
\begin{tikzpicture}[every edge quotes/.append style={auto}, scale=0.5]
  \pgfmathsetmacro{\cubex}{3}
  \pgfmathsetmacro{\cubey}{10}
  \pgfmathsetmacro{\cubez}{10}
  \draw [draw, every edge/.append style={draw, opacity=.5}]
    (0,0,0) coordinate (o) -- ++(-\cubex,0,0) coordinate (a) -- ++(0,-\cubey,0) coordinate (b) edge coordinate [pos=1] (g) ++(0,0,-\cubez)  -- ++(\cubex,0,0) coordinate (c) -- cycle
    (o) -- ++(0,0,-\cubez) coordinate (d) -- ++(0,-\cubey,0) coordinate (e) edge (g) -- (c) -- cycle
    (o) -- (a) -- ++(0,0,-\cubez) coordinate (f) edge (g) -- (d) -- cycle;

    \draw [dashed,opacity=.5] ($(c)+(-1,0,0)$) edge ($(o)+(-1,0,0)$) ($(o)+(-1,0,0)$) edge ($(d)+(-1,0,0)$) ($(d)+(-1,0,0)$) edge ($(e)+(-1,0,0)$) ($(e)+(-1,0,0)$) edge ($(c)+(-1,0,0)$);

    \draw [dashed,opacity=.5] ($(c)+(-2,0,0)$) edge ($(o)+(-2,0,0)$) ($(o)+(-2,0,0)$) edge ($(d)+(-2,0,0)$) ($(d)+(-2,0,0)$) edge ($(e)+(-2,0,0)$) ($(e)+(-2,0,0)$) edge ($(c)+(-2,0,0)$);

    \node[align=center] at ($(f) + (-2,0,-4.5)$) {Convolution-Schicht \\ (3 Feature-Maps)};
  ...
  \draw [draw, every edge/.append style={draw, opacity=.5}]
    (0,-2,-1) coordinate (o) -- ++(-\cubex,0,0) coordinate (a) -- ++(0,-\cubey,0) coordinate (b) edge coordinate [pos=1] (g) ++(0,0,-\cubez)  -- ++(\cubex,0,0) coordinate (c) -- cycle
    (o) -- ++(0,0,-\cubez) coordinate (d) -- ++(0,-\cubey,0) coordinate (e) edge (g) -- (c) -- cycle
    (o) -- (a) -- ++(0,0,-\cubez) coordinate (f) edge (g) -- (d) -- cycle;


  \pgfmathsetmacro{\cubex}{2}
  \pgfmathsetmacro{\cubey}{8}
  \pgfmathsetmacro{\cubez}{8}
  \draw [draw, every edge/.append style={draw, opacity=.5}]
    (10,-1,-1) coordinate (o1) -- ++(-\cubex,0,0) coordinate (a1) -- ++(0,-\cubey,0) coordinate (b1) edge coordinate [pos=1] (g1) ++(0,0,-\cubez)  -- ++(\cubex,0,0) coordinate (c1) -- cycle
    (o1) -- ++(0,0,-\cubez) coordinate (d1) -- ++(0,-\cubey,0) coordinate (e1) edge (g1) -- (c1) -- cycle
    (o1) -- (a1) -- ++(0,0,-\cubez) coordinate (f1) edge (g1) -- (d1) -- cycle;

    \draw [dashed,opacity=.5] ($(c1)+(-1,0,0)$) edge ($(o1)+(-1,0,0)$) ($(o1)+(-1,0,0)$) edge ($(d1)+(-1,0,0)$) ($(d1)+(-1,0,0)$) edge ($(e1)+(-1,0,0)$) ($(e1)+(-1,0,0)$) edge ($(c1)+(-1,0,0)$);

    \node[align=center] at ($(f1) + (-2,0,-4.5)$) {Convolution-Schicht \\ (2 Feature-Maps)};
  ...
  \draw [draw, every edge/.append style={draw, opacity=.5}]
    (9,-3,-2) coordinate (o1) -- ++(-\cubex,0,0) coordinate (a1) -- ++(0,-\cubey,0) coordinate (b1) edge coordinate [pos=1] (g1) ++(0,0,-\cubez)  -- ++(\cubex,0,0) coordinate (c1) -- cycle
    (o1) -- ++(0,0,-\cubez) coordinate (d1) -- ++(0,-\cubey,0) coordinate (e1) edge (g1) -- (c1) -- cycle
    (o1) -- (a1) -- ++(0,0,-\cubez) coordinate (f1) edge (g1) -- (d1) -- cycle;

    \draw [-] (o) edge (a1) (c) edge (b1) (d) edge (f1) (e) edge (g1);
  ...
  \pgfmathsetmacro{\cubez}{3}
  \draw [draw, every edge/.append style={draw, opacity=.5}]
    (0,-6,-6) coordinate (o) -- ++(-\cubex,0,0) coordinate (a) -- ++(0,-\cubey,0) coordinate (b) edge coordinate [pos=1] (g) ++(0,0,-\cubez)  -- ++(\cubex,0,0) coordinate (c) -- cycle
    (o) -- ++(0,0,-\cubez) coordinate (d) -- ++(0,-\cubey,0) coordinate (e) edge (g) -- (c) -- cycle
    (o) -- (a) -- ++(0,0,-\cubez) coordinate (f) edge (g) -- (d) -- cycle;
  ...
  \pgfmathsetmacro{\cubez}{1}
  \draw [draw, every edge/.append style={draw, opacity=.5}]
    (10,-7,-7) coordinate (o1) -- ++(-\cubex,0,0) coordinate (a1) -- ++(0,-\cubey,0) coordinate (b1) edge coordinate [pos=1] (g1) ++(0,0,-\cubez)  -- ++(\cubex,0,0) coordinate (c1) -- cycle
    (o1) -- ++(0,0,-\cubez) coordinate (d1) -- ++(0,-\cubey,0) coordinate (e1) edge (g1) -- (c1) -- cycle
    (o1) -- (a1) -- ++(0,0,-\cubez) coordinate (f1) edge (g1) -- (d1) -- cycle;

    \draw [-] (o) edge (a1) (c) edge (b1) (d) edge (f1) (e) edge (g1);
\end{tikzpicture}
    \caption{Zwei Convolution-Schichten hintereinander}%
    \label{fig:conv5}
\end{figure}
Man kann es sich so vorstellen, als ob der Filter in der Z-Achse erweitert wird.
Mit dieser Erweiterung kann auch die Eingabeschicht aus mehreren Feature-Maps bestehen.
Dadurch können auch relativ einfach farbige Bilder als Eingabe verwendet werden.
Die Eingabeschicht besteht dann aus drei Feature-Maps, nämlich einer Feature-Map für jeden Farbkanal des Bildes.
...
Allerdings wird nach dem Training der Dropout nicht mehr benutzt und dadurch werden mehr Neuronen gleichzeitig aktiv sein als während dem Trainieren.
