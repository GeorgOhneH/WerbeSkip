...
Wenn man die genaue Architektur von einem Netzwerk bestimmen will, ist dass grösste Problem,
dass es keine guten Regeln gibt an die man sich halten könnte.

Die benutze Architektur orientiert sich am AlexNet\cite{alex}, welches auch nacheinader convolution Schichten
\begin{itemize}
