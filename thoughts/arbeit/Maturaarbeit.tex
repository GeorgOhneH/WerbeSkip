...
\begin{figure}[h]%
    ...
    \qquad
    \subfloat[][generiertes Bild mit einer weisser Stelle]{{\includegraphics[width=7.5cm]{assets/images/white_square.png} }}%
...
Mit generierte Bilder auf dem einer kleinen weissen Stelle ist (8x8 Pixel, die grösse des speziellen Logos),
erhält man mit insgesamt 160'500 Bildern einen MCC von 25.9\%.
Dieser Wert ist 61.9\% schlechter als wenn das spezielle Logo auf den generierten Bildern verwendet wird.
...
als für diese Arbeit zur Verfügung stehen.
